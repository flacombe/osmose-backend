...
from .Analyser_Merge_power_pole_FR_comac import Analyser_Merge_power_pole_FR_comac
from .Analyser_Merge import SourceDataGouv

class Analyser_Merge_power_pole_FR_comac_jura (Analyser_Merge_power_pole_FR_comac):
    def __init__(self, config, logger = None):
        Analyser_Merge_power_pole_FR_comac.__init__(self, config,
